...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light nav-fixed">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active nav-link-fixed" aria-current="page" href="/restau/html/index.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active nav-link-fixed" aria-current="page" href="/restau/html/categories.php">Categories</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active nav-link-fixed" aria-current="page" href="/restau/html/foods.php">Foods</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="slider" style="position: relative; top: 80px">
        ...
        <div class="slider__explorefoods">
            ...
            <div class="container">
                <div class="row hover-blur justify-content-center" style="gap: 20px;">
                    <!-- row1 -->
