    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light nav-fixed">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active nav-link-fixed" aria-current="page" href="/html/index.html">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active nav-link-fixed" aria-current="page" href="/html/categories.html">Categories</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active nav-link-fixed" aria-current="page" href="/html/foods.html">Foods</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="slider__order">
        ...
        <div class="container order">
            <div class="slider__order-selected">
                <h5 class="selected-heading" style="background-color: #47b4d1; display: inline-block;">Selected Food
                </h5>
                <div class="row">
            ...
            <div class="slider__order-delivery">
                ...
                <form action class="deliverydetails">
                    ...
                    <textarea name="" id="" cols="30" rows="10" name="" required id=""
                        placeholder="E.g. Street, City, Country" class="delivery-input"
