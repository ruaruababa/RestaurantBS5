...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active nav-link-fixed" aria-current="page" href="/restaurantbs5/html/categories.html">Categories</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active nav-link-fixed" aria-current="page" href="/restaurantbs5/html/foods.html">Foods</a>
                    </li>
                    <li class="nav-item">
    ...
    <section style="margin-top: 80px">
        <div class="container-section" style="position: relative">
            <img src="/restaurant/img/bg.jpg" class="img-fluid" alt="Responsive image"
        ...
        <div class="row justify-content-center gap-4 hover-blur">
            ...
            <div class="col-3 hover-blur-item">
                <div class="card border">
                    <img src="/img/pizza.jpg" class="card-img-top border-radius" alt="..." />
            ...
            <div class="col-3 hover-blur-item">
                <div class="card border ">
                    <img src="/img/burger.jpg" class="card-img-top border-radius" alt="..." />
                    <div class="card-body card-body-fixed">
            ...
            <div class="col-3 hover-blur-item">
                <div class="card border ">
                    <img src="/img/momo.jpg" class="card-img-top border-radius" alt="..." />
                    <div class="card-body card-body-fixed">
