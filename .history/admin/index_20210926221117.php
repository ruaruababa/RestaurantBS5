...
<body>
    ...
    <div class="main">
        <div class="container">
            <h4 class="main__title"><a href="#" class="main__title style="text-decoration: none;">Dashboard</a></h4>
            <div class="row">
                <div class="col-lg-3 ">
                    <div class="main__dashboard">
                        <h4 class="main__dashboard-number">4</h4>
                        <span class="main__dashboard-name"><a href="/restaurantbs5/admin/category.php" style="text-decoration: none;">Dashboard</a></span>
                    </div>
