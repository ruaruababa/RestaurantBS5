            ...
            <div class="row">
                <div class="col-lg-3 ">
                    <div class="main__dashboard">
                        ...
                        <span class="main__dashboard-name"><a href="/restaurantbs5/admin/categories-admin.php" style="text-decoration: none; color:black;">Categories</a></span>
                    </div>
                ...
                <div class="col-lg-3 ">
                    <div class="main__dashboard">
                        ...
                        <span class="main__dashboard-name"><a href="/restaurantbs5/admin/food-admin.php" style="text-decoration: none; color:black;">Total orders</a></span>
                    </div>
