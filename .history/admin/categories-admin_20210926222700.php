                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Pizza</td>
                            <td>
                                <img src="/restaurantimg/menu-pizza.jpg" alt="" class="table_img">
                            </td>
                            <td>Yes</td>
                            <td>Yes</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>Burger</td>
                            <td>
                                <img src="/restaurantimg/menu-burger.jpg" alt="" class="table_img">
                            </td>
                            <td>Yes</td>
                            <td>Yes</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>Momo</td>
                            <td>
                                <img src="/restaurantimg/menu-momo.jpg" alt="" class="table_img">
                            </td>
                            <td>Yes</td>
                            <td>Yes</td>
                            <td>
