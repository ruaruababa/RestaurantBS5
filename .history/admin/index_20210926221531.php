            ...
            <div class="row">
                <div class="col-lg-3 ">
                    <div class="main__dashboard">
                        ...
                        <span class="main__dashboard-name"><a href="/restaurantbs5/admin/categories.php" style="text-decoration: none; color:black;">Dashboard</a></span>
                    </div>
                ...
                <div class="col-lg-3 ">
                    <div class="main__dashboard">
                        ...
                        <span class="main__dashboard-name"><a href="/restaurantbs5/admin/food.php" style="text-decoration: none; color:black;">Foods</a></span>
                    </div>
